      ...
      <div className="svc-hero">
        ...
        <div className="svc-hero-stats">
          {[
            ...
            { emoji: "🗺️", num: "500+",       label: "Curated packages available"   },
      ...
      <div className="tos-section">
        ...
        <div className="tos-masthead">
          ...
          <div className="tos-masthead-meta">
            ...
            <span className="tos-meta-badge">⚖️ Governed by: Sri Lankan Law</span>
          </div>
        </div>
          ...
          <main className="tos-content">
            ...
            <div id="accounts" className="tos-block">
              ...
              <ul>
                ...
                <li>Notify us immediately of any unauthorized use of your account at <a href="mailto:support@ceylonroam.com" style={{ color: "#1a6fa8" }}>support@ceylonroam.com</a>.</li>
            ...
            <div id="privacy" className="tos-block">
              ...
              <p>
                ...
                <a href="/privacy" style={{ color: "#1a6fa8", fontWeight: 600 }}>Privacy Policy</a>,
            ...
            <div id="contact" className="tos-block">
              ...
              <ul>
                <li>📧 Email: <a href="mailto:legal@ceylonroam.com" style={{ color: "#1a6fa8" }}>legal@ceylonroam.com</a></li>
