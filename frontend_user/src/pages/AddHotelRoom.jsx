      ...
      <div className="ap-card" style={{ maxWidth: 800 }}>
        ...
        <form onSubmit={handleSubmit} className="ap-form">
          ...
          <div className="ap-field-group">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", background: "var(--surface)", padding: 16, borderRadius: 16, border: "1px solid var(--border)" }}>
              {FACILITIES.map(fac => (
                <label key={fac} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "var(--ink)", cursor: "pointer" }}>
            ...
            <div className="ap-field-group">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 4 }}>
                {["Room Only", "Breakfast Included", "Half Board", "Full Board"].map(meal => (
                  <label key={meal} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "var(--ink)", cursor: "pointer" }}>
