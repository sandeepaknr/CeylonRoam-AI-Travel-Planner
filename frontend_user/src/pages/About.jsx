...
const STATS = [
  ...
  { num: "45k+", label: "AI plans created" },
  ...
  return (
    <div className="about-page">
      ...
      <section className="section about-hero active">
        ...
        <div className="about-hero-label reveal">✦ About CeylonRoam</div>
        ...
        <div className="about-hero-sub">
          ...
          <div className="about-hero-stats reveal" style={{ "--d": "0.20s" }}>
            {STATS.map((s, i) => (
        ...
        <div className="about-hero-img-wrap reveal" style={{ "--d": "0.22s" }}>
          <img
            src="https://images.unsplash.com/photo-1596797038530-2c107229654b?w=1800&auto=format&fit=crop&q=85"
            alt="Sri Lanka scenic view"
          />
          <div className="about-hero-img-caption"> Mirissa, Southern Sri Lanka</div>
        </div>
        ...
        <div className="about-container">
          ...
          <div className="about-zz-grid" style={{ marginBottom: "100px" }}>
            ...
            <div className="about-zz-img reveal" style={{ "--d": "0.15s" }}>
              <img
                src="https://images.unsplash.com/photo-1578510713340-cd23d0f44ae9?w=800&auto=format&fit=crop&q=80"
                alt="Sigiriya Rock Fortress"
                loading="lazy"
              />
              <div className="about-zz-chip br">
                <span className="about-chip-em">🏰</span>
                <div>
                  <div className="about-chip-val">Sigiriya</div>
                  <div className="about-chip-lbl">UNESCO Heritage Site</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="about-zz-grid flipped">
            ...
            <div className="about-zz-img reveal" style={{ "--d": "0.15s" }}>
              <img
                src="https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=800&auto=format&fit=crop&q=80"
                alt="Ella Sri Lanka"
                loading="lazy"
              />
              <div className="about-zz-chip tl">
                <span className="about-chip-em">⚡</span>
                <div>
                  <div className="about-chip-val">&lt; 10 sec</div>
                  <div className="about-chip-lbl">Itinerary generated</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section about-mission">
        <div className="about-container">
          <div className="about-mission-inner reveal">
            <div className="about-mission-quote-mark">"</div>
