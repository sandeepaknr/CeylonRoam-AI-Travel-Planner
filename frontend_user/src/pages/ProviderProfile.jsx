...
export default function ProviderProfile() {
 ...
 <div style={{ textAlign:"center", color:"#26658C" }}>
 ...
 <button onClick={() => navigate(-1)} style={{ marginTop:16, padding:"10px 24px", borderRadius:12, border:"none", background:"#023859", color:"#fff", cursor:"pointer" }}>
 ← Go Back
 </button>
 </div>
 </div>
 ...
 <div style={{
 height: 60,
 background: "linear-gradient(135deg, #023859 0%, #26658C 45%, #023859 100%)",
 ...
 background:"linear-gradient(135deg,#023859,#26658C)",
 border:"5px solid white",
 display:"flex", alignItems:"center", justifyContent:"center",
 fontSize:38, fontWeight:800, color:"#fff",
 boxShadow:"0 6px 24px rgba(2,56,89,0.3)",
 ...
 <h1 style={{ fontSize:"1.9rem", fontWeight:800, color:"#023859", margin:"0 0 4px" }}>
 {provider.username}
 </h1>
 ...
 <span style={{ color:"#54ACBF", fontSize:"0.85rem" }}> {provider.country || "Sri Lanka"}</span>
 <span style={{ color:"#54ACBF", fontSize:"0.85rem" }}> Member since {fmt(provider.createdAt)}</span>
 <span style={{ color:"#54ACBF", fontSize:"0.85rem" }}> {packages.length} listing{packages.length !== 1 ? "s" : ""}</span>
 </div>
 </div>

 <button onClick={() => navigate(-1)}
 style={{ padding:"10px 22px", borderRadius:12, border:"1.5px solid #A7EBF2",
 background:"#F5FCFD", cursor:"pointer", fontWeight:600, color:"#26658C",
 ...
 <div style={{ color:"#26658C", lineHeight:1.7 }}>
 ...
 return (
 <div style={{ color:"#26658C" }}>

 {/* ── Guide type badge ── */}
 <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:14 }}>
 <span style={{
 background: isChauffeur ? "#fef3c7" : "#A7EBF2",
 color: isChauffeur ? "#92400e" : "#26658C",
 padding:"5px 14px", borderRadius:9999, fontWeight:700, fontSize:"0.8rem"
 }}>
 {gtIcon} {gd.guideType}
 </span>
 {gd.experience && (
 <span style={{ fontSize:"0.82rem", color:"#26658C" }}>
 ...
 background:"#F5FCFD", borderRadius:12, padding:"16px 20px", marginBottom:16
 }}>
 <div><span style={{ fontSize:"0.72rem", fontWeight:700, textTransform:"uppercase",
 letterSpacing:"0.8px", color:"#54ACBF" }}>Full Name</span>
 <p style={{ margin:"3px 0 0", fontWeight:600, color:"#011C40" }}>{gd.fullName || "—"}</p></div>

 <div><span style={{ fontSize:"0.72rem", fontWeight:700, textTransform:"uppercase",
 letterSpacing:"0.8px", color:"#54ACBF" }}>Base City</span>
 <p style={{ margin:"3px 0 0", fontWeight:600, color:"#011C40" }}> {gd.baseCity || "—"}</p></div>

 <div><span style={{ fontSize:"0.72rem", fontWeight:700, textTransform:"uppercase",
 letterSpacing:"0.8px", color:"#54ACBF" }}>Languages</span>
 <p style={{ margin:"3px 0 0", fontWeight:600, color:"#011C40" }}> {gd.languages || "—"}</p></div>

 <div><span style={{ fontSize:"0.72rem", fontWeight:700, textTransform:"uppercase",
 letterSpacing:"0.8px", color:"#54ACBF" }}>Operating Regions</span>
 <p style={{ margin:"3px 0 0", fontWeight:600, color:"#011C40" }}> {gd.operatingRegions || "All Sri Lanka"}</p></div>
 </div>

 {/* ── Bio ── */}
 {gd.bio && (
 <div style={{ background:"#F5FCFD", borderLeft:"4px solid #38bdf8",
 borderRadius:"0 10px 10px 0", padding:"12px 16px", marginBottom:16 }}>
 <p style={{ margin:0, lineHeight:1.7, fontSize:"0.9rem", color:"#26658C" }}>{gd.bio}</p>
 </div>
 )}
 ...
 {isChauffeur && (
 <>
 <div style={{ fontWeight:700, color:"#011C40", fontSize:"0.95rem",
 marginBottom:12, paddingTop:4, borderTop:"1px solid #A7EBF2", paddingTop:14 }}>
 Vehicle Details
 </div>
 ...
 letterSpacing:"0.8px", color:"#54ACBF" }}>{row.label}</span>
 <p style={{ margin:"3px 0 0", fontWeight:600, color:"#011C40",
 ...
 {photos.length > 0 && (
 <>
 <div style={{ fontWeight:700, color:"#011C40", fontSize:"0.88rem",
 ...
 border:"2px solid #A7EBF2", lineHeight:0 }}>
 <img
 ...
 <h3 style={{ marginBottom: 8, color:"#023859" }}>
 Published Listings
 <span style={{ marginLeft:10, fontSize:"0.85rem", fontWeight:500, color:"#54ACBF" }}>
 ({packages.length} total)
 </span>
 </h3>

 {packages.length === 0 ? (
 <p style={{ color:"#54ACBF", textAlign:"center", padding:"30px 0" }}>
