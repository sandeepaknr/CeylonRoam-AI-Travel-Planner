...
export default function RequestBusiness() {
    ...
    return (
      <div className="request-biz-container">
        <div className="status-card-pending">
          ...
          <p style={{ marginTop: 8, color: "#94a3b8", fontSize: "0.9rem" }}>Your registered country: <strong>{user.country || "Not set"}</strong></p>
  ...
  const renderTransportForm = () => (
    <>
      ...
      <div className="partner-section">
        <h3 className="section-title">🗺️ Service Area</h3>
        <div className="two-col">
